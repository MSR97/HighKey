...
import mohammadsajjad.magikey.databinding.AllItemBinding;
import mohammadsajjad.magikey.databinding.FragmentGetAllBinding;
import mohammadsajjad.magikey.model.Movies;

public class MoviesAllAdapter extends RecyclerView.Adapter<MoviesAllAdapter.MovieViewHolder> {
    ...
    public MovieViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        AllItemBinding allBinding= DataBindingUtil.inflate(inflater, R.layout.all_item, parent, false);

        return new MovieViewHolder(allBinding);
    }
        ...
        allBinding.getRoot().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(position!=RecyclerView.NO_POSITION){
                    Movies Selectedmovies=moviesArrayList.get(position);
